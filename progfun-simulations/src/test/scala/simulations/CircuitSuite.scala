...
class CircuitSuite extends CircuitSimulator with FunSuite {
  ...
  test("orGate example") {
    ...
    assert(out.getSignal === false, "and 5")
  }

  test("orGate2 example") {
    println(s"orGate2 example")
    val in1, in2, out = new Wire
    orGate2(in1, in2, out)
    in1.setSignal(false)
    in2.setSignal(false)
  ...
  test("Circuit.andGateExample") {
    println(s"Circuit.andGateExample")
    Circuit.andGateExample
  }

  test("Circuit.orGateExample") {
    println(s"Circuit.orGateExample")
    Circuit.orGateExample
  }

  test("Circuit.demuxExample") {
    println(s"Circuit.demuxExample")
