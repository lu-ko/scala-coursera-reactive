# Introduction to Scala and Reactive Programming

**Week:** 1

**Assignment:** Quickcheck

**Project:** progfun-quickcheck
...
All these operations are pure; they never modify the given heaps, and may return new heaps. This purely functional interface is taken from Brodal & Okasaki’s paper, Optimal Purely Functional Priority Queues (see http://www.brics.dk/RS/96/37/BRICS-RS-96-37.pdf).
